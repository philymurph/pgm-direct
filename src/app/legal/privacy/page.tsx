    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-sm mt-8 max-w-none text-slate-700">
        ...
        <ul>
          ...
          <li>
            Payment information: processed directly by Revolut — we never see or
            store your full card details.
          </li>
          <li>
            Contact form submissions: name, email, phone and the content of your
            message.
          </li>
          <li>
            Technical data: IP address and basic usage data, used for security
            (e.g. rate limiting) and site functionality.
          </li>
        </ul>

        <h2>3. Why we use it</h2>
        <p>
          To process and deliver your orders, provide customer support, maintain
          your account, and comply with tax and accounting obligations. We do
        ...
        <p>
          ...
          purposes. Account data is retained while your account is active, or
